# tauri-confirmation-dialog Specification

## Purpose
Define requirements for using Tauri's dialog plugin for native confirmation dialogs instead of browser's `window.confirm()`.

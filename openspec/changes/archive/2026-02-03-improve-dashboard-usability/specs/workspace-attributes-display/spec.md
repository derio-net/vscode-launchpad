...
## Purpose
Define the requirements for displaying detailed workspace attributes (SSH Host, Path) based on workspace type, making it easier to distinguish between similar workspaces.
